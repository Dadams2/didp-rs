...
use dypdl_heuristic_search::{create_dual_bound_id_astar, FEvaluatorType, Parameters, Search};
use std::error::Error;
use std::fmt;
use std::rc::Rc;
use std::str;
    ...
    <T as str::FromStr>::Err: fmt::Debug,
{
    let map = match config {
        ...
        yaml_rust::Yaml::Null => {
            return Ok(create_dual_bound_id_astar(
                Rc::new(model),
                Parameters {
